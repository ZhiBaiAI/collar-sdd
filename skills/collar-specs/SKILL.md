...
3. **登记覆盖索引**：在 [docs/runbook/testing.md](../../docs/runbook/testing.md) §5 加一行本功能点。
...
- [ ] 已在 `docs/runbook/testing.md` §5 覆盖索引登记本功能点
...
> **测试覆盖漂移是本次新增的检查项**：验收标准与测试点之间靠 `AC-N` 编号机械对齐，
> 因此「哪条 AC 没测」是可算出来的，不靠人回忆。核对口径见
> [docs/runbook/testing.md](../../docs/runbook/testing.md) 与 `tests.md` 的「覆盖核对」小节。
